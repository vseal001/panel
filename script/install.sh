...
+----------------------------------------------------------------------
| Copyright (c) 2015-2017 BT-SOFT(http://bthome.ai0128.com) All rights reserved.
+----------------------------------------------------------------------
| Python2.6/2.7 successful the http://SERVER_IP:8888 is WebPanel
+----------------------------------------------------------------------
"

download_Url='http://btdownload.ai0128.com'
setup_patn=/www
...
curl http://bthome.ai0128.com/Api/SetupCount?type=Linux
