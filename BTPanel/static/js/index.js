            ...
            if (rdata.status === false) {
                ...
                var loading = bt.open({
                    ...
                    content: '<div class="setchmod bt-form">\
                                ...
                                <div class="update_version">当前版本：<a href="http://bthome.ai0128.com/bbs/forum.php?mod=viewthread&tid=19376" target="_blank" class="btlink" title="查看当前版本日志">宝塔Linux'+ (rdata.msg.is_beta == 1 ? '测试版 ' + rdata.msg.beta.version : '正式版 ' + rdata.msg.version) + '</a>&nbsp;&nbsp;发布时间：' + (rdata.msg.is_beta == 1 ? rdata.msg.beta.uptime : rdata.msg.uptime) + '</div>\
