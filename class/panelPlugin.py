...
class panelPlugin:
    ...
    def install_sync(self,pluginInfo,get):
        if 'download' in pluginInfo['versions'][0]:
            ...
            public.downloadFile('http://bthome.ai0128.com/api/Pluginother/get_file?fname=' + pluginInfo['versions'][0]['download'],toFile)
    ...
    def install(self,get):
        ...
        if pluginInfo['tip'] == 'lib':
            ...
            if not 'download_url' in session: session['download_url'] = 'http://btdownload.ai0128.com'
            download_url = session['download_url'] + '/install/plugin/' + pluginInfo['name'] + '/install.sh'
    ...
    def getCloudPlugin(self,get):
        ...
        import json
        if not session.get('download_url'): session['download_url'] = 'http://btdownload.ai0128.com'
