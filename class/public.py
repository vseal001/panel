...
def get_url(timeout = 0.5):
    ...
    try:
        ...
        return 'http://btdownload.ai0128.com'
...
def submit_error(err_msg = None):
    try:
        ...
        httpPost("http://bthome.ai0128.com/api/panel/s_error",pdata,timeout=3)
    except:
        pass
...
def sync_date():
    ...
    try:
        if os.path.exists(tip_file):
            ...
            os.remove(tip_file)
        time_str = HttpGet('http://bthome.ai0128.com/api/index/get_time')
