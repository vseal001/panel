...
class plugin_deployment:
    ...
    def get_icon(self,pinfo):
        ...
        os.system("wget -O " + filename + ' http://bthome.ai0128.com' + m_uri + " &")
        return pinfo
    ...
    def GetCloudList(self,get):
        try:
            ...
            if not 'package' in session or not os.path.exists(jsonFile) or hasattr(get,'force'):
                downloadUrl = 'http://bthome.ai0128.com/api/panel/get_deplist';
    ...
    def SetupPackage(self,get):
        ...
        if isDownload:
            ...
            if pinfo['versions'][0]['download']: self.DownloadFile('http://bthome.ai0128.com/api/Pluginother/get_file?fname=' + pinfo['versions'][0]['download'], packageZip);
    ...
    def depTotal(self,id):
        ...
        pdata['pid'] = id;
        p_url = 'http://bthome.ai0128.com/api/pluginother/create_order_okey'
